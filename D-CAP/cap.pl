...
require "/media/cfz/23z-5/seismictool/gcap_source_rp/m5/cap_plt.pl";	# include plot script

#================defaults======================================
$cmd = "cap";
$green = "/media/cfz/23z-5/seismictool/gcap_source_rp/m5/Glib";	#green's function location
$repeat = 0;
$bootstrap = 0;
$fm_thr = 0.01;
$dirct='';
